...
def recommend():
    ...
    sym_des = pd.read_excel('symtoms_df.xlsx')
    precautions = pd.read_excel('precautions_df.xlsx')
    workout = pd.read_excel('workout_df.xlsx')
    description = pd.read_excel('description.xlsx')
    medications = pd.read_excel('medications.xlsx')
    ...
    st.title(":blue[User Input]")

    # Get user symptoms from the sidebar
    user_symptoms = st.text_input("Enter your symptoms (comma-separated):")
    ...
    if st.button("Predict"):
        ...
        # Display the predicted disease and other information
        st.header("Predicted Disease:")
        st.write(predicted_disease)

        # Get additional information using the helper function
